...
<main class="flex-1 flex flex-col items-center mt-10 sm:mt-4 text-gray-800 mb-8">
  ...
  <article class="px-4 sm:px-6 py-4 text-xl flex flex-col justify-center min-h-screen" id="intro">
    ...
    <div>
      <a class="inline-block group transition-all" href="#about-me">
  ...
  <article
    class="px-4 sm:px-6 py-4 pt-24 sm:pt-36 text-base flex flex-col justify-center"
    id="about-me"
  >
    <AboutMe />
  </article>
  ...
  <article
    class="px-4 sm:px-6 py-4 pt-24 sm:pt-36 text-base flex flex-col justify-center w-full"
    id="experience"
  >
    <Experience />
  </article>
  ...
  <article
    class="px-4 sm:px-6 py-24 text-base flex flex-col justify-center text-center"
    id="contact"
  >
    <section class="bg-blue-50 rounded-3xl py-12 md:py-24 px-6 md:px-12">
      <h2 class="text-4xl xl:text-5xl font-bold mb-8">Say Hi!</h2>
      <p class="mb-8">
        While I'm not currently looking for new opportunities, I'm always eager to talk or answer
        questions. Send me a mail and I'll try my best to get back to you soon-ish!
      </p>
      <a class="inline-block group transition-all" href="mailto:joakim.wimmerstedt@gmail.com">
        📬 Drop me a message <span class="inline-block transition-all group-hover:translate-x-4"
          >→</span
        >
      </a>
    </section>
